...
def plot_skewness_pyplot(numerical_df, title="skewness", xaxis_label="variable", yaxis_label="skewness", color_palette='Blues_d'):
    """
...
def log_transform(df, skew_threshold=0.5, exclude=None):
    ...
    for column in df_transformed.columns:
        ...
        if skew(df_transformed[column]) > skew_threshold and column not in exclude:
