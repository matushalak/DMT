...
def filter_final_features(df: pd.DataFrame) -> pd.DataFrame:
    allowed_columns = [
        ...
        'visitor_hist_starrating_zscore', 'visitor_hist_starrating_rank', "log_orig_destination_distance",'price_usd_mean', 'random_bool_mean', 'prop_location_score2_mean', 'srch_query_affinity_score_mean',
'srch_length_of_stay_mean', 'prop_log_historical_price_mean', 'promotion_flag_mean', 'comp5_rate_mean',
'orig_destination_distance_mean', 'srch_room_count_mean', 'srch_booking_window_mean',
'srch_saturday_night_bool_mean', 'comp3_inv_mean', 'srch_children_count_mean', 'comp8_rate_mean',
'comp8_inv_mean', 'comp3_rate_percent_diff_mean', 'comp8_rate_percent_diff_mean',
'comp5_rate_percent_diff_mean', 'comp2_rate_percent_diff_mean', 'price_usd_std', 'random_bool_std', 'prop_location_score2_std', 'srch_query_affinity_score_std',
'comp8_inv_std', 'srch_room_count_std', 'prop_log_historical_price_std', 'promotion_flag_std',
'srch_length_of_stay_std', 'visitor_location_country_id_std', 'comp3_rate_percent_diff_std',
'comp8_rate_std', 'comp5_rate_percent_diff_std', 'comp8_rate_percent_diff_std', 'comp3_rate_std',
'orig_destination_distance_std', 'month_std', 'comp2_rate_percent_diff_std', 'comp5_rate_std',
'srch_children_count_std', 'price_usd_median', 'prop_log_historical_price_median', 'prop_location_score2_median',
'srch_query_affinity_score_median', 'orig_destination_distance_median', 'srch_booking_window_median',
'comp3_rate_percent_diff_median', 'comp5_rate_percent_diff_median', 'comp8_rate_percent_diff_median',
'comp2_rate_percent_diff_median', 'visitor_hist_starrating_median', 'srch_length_of_stay_median',
'visitor_hist_adr_usd_median', 'comp5_rate_median', 'promotion_flag_median'
    ]
...
def split_and_test():
    ...
    # add prop_id stats + found variables to whole dataset
    df = add_prop_id_statistics(df, top_means, 'mean') 
    df = add_prop_id_statistics(df, top_stds, 'std')
    df = add_prop_id_statistics(df, top_medians, 'median')
    df = add_found_features(df, feature_methods)
