...
def load_data_and_split(force_raw: bool = False, save_processed_data: bool = False):
        # ---------- TRAINING DATA ----------
    if os.path.exists("data/processed_train.csv") and not force_raw:
        ...
        processed_train_df, encoder = train_preprocessor.run_pipeline(
            is_test=False, save=save_processed_data, name="train"
        )

    # ---------- VALIDATION DATA ----------
    if os.path.exists("data/processed_val.csv"):
        ...
        processed_val_df = val_preprocessor.run_pipeline(
            is_test=True, encoder=encoder, save=save_processed_data, name="val"
        )
...
if __name__ == "__main__":
    ...
    # hyperparameter_tuning_example(save_processed_data=True)
